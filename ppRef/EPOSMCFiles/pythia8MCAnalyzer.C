...
void pythia8MCAnalyzer(){
  ...
  TFile * input = TFile::Open("EPOS5TeV_Dec2.root","read");
  ...
  TFile * input544 = TFile::Open("EPOS544TeV_Dec2.root","read");
  ...
  TFile * input7 = TFile::Open("EPOS7TeV_Dec2.root","read");
  ...
  TH1D * pythia8_7 = (TH1D*)pythia8MB7->Clone("EPOS_7");

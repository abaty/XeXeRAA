...
void pythia8MCAnalyzer(int job, int nEvtPerFile = 10000000){
  ...
  for(int f = job+1; f<job+2; f++){
    ...
    //TFile * input_pythiaMB = TFile::Open(Form("/mnt/hadoop/cms/store/user/abaty/XeXeRAAMC/EPOS544_v2/EPOSMB_544TeV/EPOS_544TeV/171123_153356/0000/output__%d.root",f),"read");

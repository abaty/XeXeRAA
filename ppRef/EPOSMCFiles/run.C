...
void pythia8MCAnalyzer(int job, int nEvtPerFile = 10000000){
  ...
  for(int f = job+1; f<job+2; f++){
    std::cout << f << std::endl;
    TFile * input_pythiaMB = TFile::Open(Form("/mnt/hadoop/cms/store/user/abaty/XeXeRAAMC/EPOS544/EPOSMB_544TeV/EPOS_544TeV/171114_233549/0000/output_%d.root",f),"read");
    //TFile * input_pythiaMB = TFile::Open(Form("/mnt/hadoop/cms/store/user/abaty/XeXeRAAMC/EPOS5/EPOSMB_5TeV/EPOS_5TeV/171114_233526/0000/output_%d.root",f),"read");

...
void pythia8MCAnalyzer(){
  ...
  TFile * output = TFile::Open("HerwigppSpectra.root","recreate");
  output->cd();
  TH1D * pythia8 = (TH1D*)pythia8MB->Clone("Herwigpp_5");
  pythia8->Add(pythia8Hard);
  
  TH1D * pythia8_544 = (TH1D*)pythia8MB544->Clone("Herwigpp_544");
